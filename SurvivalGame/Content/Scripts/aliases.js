...
try { let fnprepatch_761 = AsyncEditorDelay.prototype.AsyncEditorDelay;AsyncEditorDelay.prototype.AsyncEditorDelay = function (Seconds, MinimumFrames = 30) { return fnprepatch_761.call(this, Seconds, MinimumFrames) }; } catch (e) {};
try { let fnprepatch_762 = AsyncEditorWaitForGameWorld.prototype.AsyncWaitForGameWorld;AsyncEditorWaitForGameWorld.prototype.AsyncWaitForGameWorld = function (Index = 0, Server = false) { return fnprepatch_762.call(this, Index, Server) }; } catch (e) {};
try { EditorUtilityTask.prototype.BeginExecution = EditorUtilityTask.prototype.ReceiveBeginExecution; } catch (e) {};
try { let fnprepatch_763 = EditorValidatorSubsystem.prototype.ValidateAssets;EditorValidatorSubsystem.prototype.ValidateAssets = function (AssetDataList, bSkipExcludedDirectories = true, bShowIfNoFailures = true) { return fnprepatch_763.call(this, AssetDataList, bSkipExcludedDirectories, bShowIfNoFailures) }; } catch (e) {};
...
try { let fnprepatch_808 = ImgMediaSource.prototype.AddTargetObject;ImgMediaSource.prototype.AddTargetObject = function (InActor, Width = -1) { return fnprepatch_808.call(this, InActor, Width) }; } catch (e) {};
...
try { let fnprepatch_809 = SimpleCartesianPlot.prototype.BP_AddSeriesWithId;SimpleCartesianPlot.prototype.BP_AddSeriesWithId = function (bSuccess, Id, Name, bEnabled = true, bShowPoints = true, bShowLines = false) { return fnprepatch_809.call(this, bSuccess, Id, Name, bEnabled, bShowPoints, bShowLines) }; } catch (e) {};
try { let fnprepatch_810 = SimpleCartesianPlot.prototype.BP_AddSeries;SimpleCartesianPlot.prototype.BP_AddSeries = function (SeriesId, Name, bEnabled = true, bShowPoints = true, bShowLines = false) { return fnprepatch_810.call(this, SeriesId, Name, bEnabled, bShowPoints, bShowLines) }; } catch (e) {};
...
try { let fnprepatch_811 = SimpleTimeSeriesPlot.prototype.BP_AddSeriesWithId;SimpleTimeSeriesPlot.prototype.BP_AddSeriesWithId = function (bSuccess, Id, Name, bEnabled = true, bShowPoints = true, bShowLines = false) { return fnprepatch_811.call(this, bSuccess, Id, Name, bEnabled, bShowPoints, bShowLines) }; } catch (e) {};
try { let fnprepatch_812 = SimpleTimeSeriesPlot.prototype.BP_AddSeries;SimpleTimeSeriesPlot.prototype.BP_AddSeries = function (SeriesId, Name, bEnabled = true, bShowPoints = true, bShowLines = false) { return fnprepatch_812.call(this, SeriesId, Name, bEnabled, bShowPoints, bShowLines) }; } catch (e) {};
