...
try { let fnprepatch_744 = AsyncEditorDelay.prototype.AsyncEditorDelay;AsyncEditorDelay.prototype.AsyncEditorDelay = function (Seconds, MinimumFrames = 30) { return fnprepatch_744.call(this, Seconds, MinimumFrames) }; } catch (e) {};
try { let fnprepatch_745 = AsyncEditorWaitForGameWorld.prototype.AsyncWaitForGameWorld;AsyncEditorWaitForGameWorld.prototype.AsyncWaitForGameWorld = function (Index = 0, Server = false) { return fnprepatch_745.call(this, Index, Server) }; } catch (e) {};
try { EditorUtilityTask.prototype.BeginExecution = EditorUtilityTask.prototype.ReceiveBeginExecution; } catch (e) {};
try { let fnprepatch_746 = EditorValidatorSubsystem.prototype.ValidateAssets;EditorValidatorSubsystem.prototype.ValidateAssets = function (AssetDataList, bSkipExcludedDirectories = true, bShowIfNoFailures = true) { return fnprepatch_746.call(this, AssetDataList, bSkipExcludedDirectories, bShowIfNoFailures) }; } catch (e) {};
try { let fnprepatch_747 = NiagaraComponent.prototype.SetAsset;NiagaraComponent.prototype.SetAsset = function (InAsset, bResetExistingOverrideParameters = true) { return fnprepatch_747.call(this, InAsset, bResetExistingOverrideParameters) }; } catch (e) {};
...
try { let fnprepatch_748 = NiagaraFunctionLibrary.prototype.SpawnSystemAttached;NiagaraFunctionLibrary.prototype.SpawnSystemAttached = function (SystemTemplate, AttachToComponent, AttachPointName, Location, Rotation, LocationType, bAutoDestroy, bAutoActivate = true, PoolingMethod = "None", bPreCullCheck = true) { return fnprepatch_748.call(this, SystemTemplate, AttachToComponent, AttachPointName, Location, Rotation, LocationType, bAutoDestroy, bAutoActivate, PoolingMethod, bPreCullCheck) }; } catch (e) {};
try { let fnprepatch_749 = NiagaraFunctionLibrary.prototype.SpawnSystemAtLocation;NiagaraFunctionLibrary.prototype.SpawnSystemAtLocation = function (WorldContextObject, SystemTemplate, Location, Rotation, Scale, bAutoDestroy = true, bAutoActivate = true, PoolingMethod = "None", bPreCullCheck = true) { return fnprepatch_749.call(this, WorldContextObject, SystemTemplate, Location, Rotation, Scale, bAutoDestroy, bAutoActivate, PoolingMethod, bPreCullCheck) }; } catch (e) {};
...
try { let fnprepatch_750 = NiagaraClipboardEditorScriptingUtilities.prototype.TrySetLocalValueAsInt;NiagaraClipboardEditorScriptingUtilities.prototype.TrySetLocalValueAsInt = function (InInput, bOutSucceeded, InValue, bLooseTyping = true) { return fnprepatch_750.call(this, InInput, bOutSucceeded, InValue, bLooseTyping) }; } catch (e) {};
try { let fnprepatch_751 = TemplateSequenceActor.prototype.SetBinding;TemplateSequenceActor.prototype.SetBinding = function (Actor, bOverridesDefault = true) { return fnprepatch_751.call(this, Actor, bOverridesDefault) }; } catch (e) {};
try { let fnprepatch_752 = MatineeCameraShake.prototype.StartMatineeCameraShakeFromSource;MatineeCameraShake.prototype.StartMatineeCameraShakeFromSource = function (PlayerCameraManager, ShakeClass, SourceComponent, Scale = 1, PlaySpace = "CameraLocal", UserPlaySpaceRot) { return fnprepatch_752.call(this, PlayerCameraManager, ShakeClass, SourceComponent, Scale, PlaySpace, UserPlaySpaceRot) }; } catch (e) {};
try { let fnprepatch_753 = MatineeCameraShake.prototype.StartMatineeCameraShake;MatineeCameraShake.prototype.StartMatineeCameraShake = function (PlayerCameraManager, ShakeClass, Scale = 1, PlaySpace = "CameraLocal", UserPlaySpaceRot) { return fnprepatch_753.call(this, PlayerCameraManager, ShakeClass, Scale, PlaySpace, UserPlaySpaceRot) }; } catch (e) {};
...
try { let fnprepatch_754 = MagicLeapHandTrackingFunctionLibrary.prototype.SetConfiguration;MagicLeapHandTrackingFunctionLibrary.prototype.SetConfiguration = function (StaticGesturesToActivate, KeypointsFilterLevel = "NoFilter", GestureFilterLevel = "NoFilter", bTrackingEnabled = true) { return fnprepatch_754.call(this, StaticGesturesToActivate, KeypointsFilterLevel, GestureFilterLevel, bTrackingEnabled) }; } catch (e) {};
try { let fnprepatch_755 = PythonScriptLibrary.prototype.ExecutePythonCommandEx;PythonScriptLibrary.prototype.ExecutePythonCommandEx = function (PythonCommand, CommandResult, LogOutput, ExecutionMode = "ExecuteFile", FileExecutionScope = "Private") { return fnprepatch_755.call(this, PythonCommand, CommandResult, LogOutput, ExecutionMode, FileExecutionScope) }; } catch (e) {};
...
try { let fnprepatch_756 = VaRestJsonObject.prototype.WriteToFilePath;VaRestJsonObject.prototype.WriteToFilePath = function (Path, bIsRelativeToProjectDir = true) { return fnprepatch_756.call(this, Path, bIsRelativeToProjectDir) }; } catch (e) {};
try { let fnprepatch_757 = VaRestJsonObject.prototype.DecodeJson;VaRestJsonObject.prototype.DecodeJson = function (JsonString, bUseIncrementalParser = true) { return fnprepatch_757.call(this, JsonString, bUseIncrementalParser) }; } catch (e) {};
try { let fnprepatch_758 = VaRestRequestJSON.prototype.SetURL;VaRestRequestJSON.prototype.SetURL = function (Url = "http://alyamkin.com") { return fnprepatch_758.call(this, Url) }; } catch (e) {};
try { let fnprepatch_759 = VaRestRequestJSON.prototype.ProcessURL;VaRestRequestJSON.prototype.ProcessURL = function (Url = "http://alyamkin.com") { return fnprepatch_759.call(this, Url) }; } catch (e) {};
try { let fnprepatch_760 = VaRestRequestJSON.prototype.GetResponseContentAsString;VaRestRequestJSON.prototype.GetResponseContentAsString = function (bCacheResponseContent = true) { return fnprepatch_760.call(this, bCacheResponseContent) }; } catch (e) {};
try { let fnprepatch_761 = VaRestSubsystem.prototype.LoadJsonFromFile;VaRestSubsystem.prototype.LoadJsonFromFile = function (Path, bIsRelativeToContentDir = true) { return fnprepatch_761.call(this, Path, bIsRelativeToContentDir) }; } catch (e) {};
...
try { let fnprepatch_765 = JavascriptLibrary.prototype.ReadStringFromFile;JavascriptLibrary.prototype.ReadStringFromFile = function (Object, Filename, ReadFlags = "FILEREAD_None") { return fnprepatch_765.call(this, Object, Filename, ReadFlags) }; } catch (e) {};
try { let fnprepatch_766 = JavascriptLibrary.prototype.DeleteFile;JavascriptLibrary.prototype.DeleteFile = function (Filename, ReadOnly = false) { return fnprepatch_766.call(this, Filename, ReadOnly) }; } catch (e) {};
try { let fnprepatch_767 = JavascriptLibrary.prototype.CreateSocket;JavascriptLibrary.prototype.CreateSocket = function (SocketType, Description, bForceUDP = false) { return fnprepatch_767.call(this, SocketType, Description, bForceUDP) }; } catch (e) {};
try { let fnprepatch_768 = JavascriptProcess.prototype.Terminate;JavascriptProcess.prototype.Terminate = function (KillTree = false) { return fnprepatch_768.call(this, KillTree) }; } catch (e) {};
try { let fnprepatch_769 = JavascriptUMGLibrary.prototype.AddWindow;JavascriptUMGLibrary.prototype.AddWindow = function (NewWindow, bShowImmediately = true) { return fnprepatch_769.call(this, NewWindow, bShowImmediately) }; } catch (e) {};
try { let fnprepatch_770 = JavascriptWebSocket.prototype.RemoteEndPoint;JavascriptWebSocket.prototype.RemoteEndPoint = function (bAppendPort = true) { return fnprepatch_770.call(this, bAppendPort) }; } catch (e) {};
try { let fnprepatch_771 = JavascriptWebSocket.prototype.LocalEndPoint;JavascriptWebSocket.prototype.LocalEndPoint = function (bAppendPort = true) { return fnprepatch_771.call(this, bAppendPort) }; } catch (e) {};
...
try { let fnprepatch_780 = SimpleCartesianPlot.prototype.BP_AddSeriesWithId;SimpleCartesianPlot.prototype.BP_AddSeriesWithId = function (bSuccess, Id, Name, bEnabled = true, bShowPoints = true, bShowLines = false) { return fnprepatch_780.call(this, bSuccess, Id, Name, bEnabled, bShowPoints, bShowLines) }; } catch (e) {};
try { let fnprepatch_781 = SimpleCartesianPlot.prototype.BP_AddSeries;SimpleCartesianPlot.prototype.BP_AddSeries = function (SeriesId, Name, bEnabled = true, bShowPoints = true, bShowLines = false) { return fnprepatch_781.call(this, SeriesId, Name, bEnabled, bShowPoints, bShowLines) }; } catch (e) {};
...
try { let fnprepatch_782 = SimpleTimeSeriesPlot.prototype.BP_AddSeriesWithId;SimpleTimeSeriesPlot.prototype.BP_AddSeriesWithId = function (bSuccess, Id, Name, bEnabled = true, bShowPoints = true, bShowLines = false) { return fnprepatch_782.call(this, bSuccess, Id, Name, bEnabled, bShowPoints, bShowLines) }; } catch (e) {};
try { let fnprepatch_783 = SimpleTimeSeriesPlot.prototype.BP_AddSeries;SimpleTimeSeriesPlot.prototype.BP_AddSeries = function (SeriesId, Name, bEnabled = true, bShowPoints = true, bShowLines = false) { return fnprepatch_783.call(this, SeriesId, Name, bEnabled, bShowPoints, bShowLines) }; } catch (e) {};
