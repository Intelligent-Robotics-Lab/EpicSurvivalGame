...
try { let fnprepatch_694 = AchievementWriteCallbackProxy.prototype.WriteAchievementProgress;AchievementWriteCallbackProxy.prototype.WriteAchievementProgress = function (WorldContextObject, PlayerController, AchievementName, Progress = 100, UserTag = 0) { return fnprepatch_694.call(this, WorldContextObject, PlayerController, AchievementName, Progress, UserTag) }; } catch (e) {};
...
try { let fnprepatch_695 = MagicLeapHMDFunctionLibrary.prototype.SetStabilizationDepthActor;MagicLeapHMDFunctionLibrary.prototype.SetStabilizationDepthActor = function (InStabilizationDepthActor, bSetFocusActor = true) { return fnprepatch_695.call(this, InStabilizationDepthActor, bSetFocusActor) }; } catch (e) {};
try { let fnprepatch_696 = MagicLeapHMDFunctionLibrary.prototype.SetFocusActor;MagicLeapHMDFunctionLibrary.prototype.SetFocusActor = function (InFocusActor, bSetStabilizationActor = true) { return fnprepatch_696.call(this, InFocusActor, bSetStabilizationActor) }; } catch (e) {};
...
try { let fnprepatch_772 = JavascriptComponent.prototype.ResolveAsset;JavascriptComponent.prototype.ResolveAsset = function (Name, bTryLoad = true) { return fnprepatch_772.call(this, Name, bTryLoad) }; } catch (e) {};
try { let fnprepatch_773 = JavascriptContext.prototype.RunScript;JavascriptContext.prototype.RunScript = function (Script, bOutput = true) { return fnprepatch_773.call(this, Script, bOutput) }; } catch (e) {};
try { let fnprepatch_774 = JavascriptContext.prototype.CreateInspector;JavascriptContext.prototype.CreateInspector = function (Port = 9229) { return fnprepatch_774.call(this, Port) }; } catch (e) {};
try { let fnprepatch_775 = JavascriptLibrary.prototype.ReadStringFromFile;JavascriptLibrary.prototype.ReadStringFromFile = function (Object, Filename, ReadFlags = "FILEREAD_None") { return fnprepatch_775.call(this, Object, Filename, ReadFlags) }; } catch (e) {};
try { let fnprepatch_776 = JavascriptLibrary.prototype.DeleteFile;JavascriptLibrary.prototype.DeleteFile = function (Filename, ReadOnly = false) { return fnprepatch_776.call(this, Filename, ReadOnly) }; } catch (e) {};
try { let fnprepatch_777 = JavascriptLibrary.prototype.CreateSocket;JavascriptLibrary.prototype.CreateSocket = function (SocketType, Description, bForceUDP = false) { return fnprepatch_777.call(this, SocketType, Description, bForceUDP) }; } catch (e) {};
try { let fnprepatch_778 = JavascriptProcess.prototype.Terminate;JavascriptProcess.prototype.Terminate = function (KillTree = false) { return fnprepatch_778.call(this, KillTree) }; } catch (e) {};
try { let fnprepatch_779 = JavascriptUMGLibrary.prototype.AddWindow;JavascriptUMGLibrary.prototype.AddWindow = function (NewWindow, bShowImmediately = true) { return fnprepatch_779.call(this, NewWindow, bShowImmediately) }; } catch (e) {};
try { let fnprepatch_780 = JavascriptWebSocket.prototype.RemoteEndPoint;JavascriptWebSocket.prototype.RemoteEndPoint = function (bAppendPort = true) { return fnprepatch_780.call(this, bAppendPort) }; } catch (e) {};
try { let fnprepatch_781 = JavascriptWebSocket.prototype.LocalEndPoint;JavascriptWebSocket.prototype.LocalEndPoint = function (bAppendPort = true) { return fnprepatch_781.call(this, bAppendPort) }; } catch (e) {};
...
try { let fnprepatch_807 = ImgMediaSource.prototype.AddTargetObject;ImgMediaSource.prototype.AddTargetObject = function (InActor, Width = -1) { return fnprepatch_807.call(this, InActor, Width) }; } catch (e) {};
...
try { let fnprepatch_809 = AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToTIFF;AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToTIFF = function (SourceImage, bWantColor = true, bUseGpu = true, Scale = 1, Rotate = "None") { return fnprepatch_809.call(this, SourceImage, bWantColor, bUseGpu, Scale, Rotate) }; } catch (e) {};
try { let fnprepatch_810 = AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToPNG;AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToPNG = function (SourceImage, bWantColor = true, bUseGpu = true, Scale = 1, Rotate = "None") { return fnprepatch_810.call(this, SourceImage, bWantColor, bUseGpu, Scale, Rotate) }; } catch (e) {};
try { let fnprepatch_811 = AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToJPEG;AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToJPEG = function (SourceImage, Quality = 85, bWantColor = true, bUseGpu = true, Scale = 1, Rotate = "None") { return fnprepatch_811.call(this, SourceImage, Quality, bWantColor, bUseGpu, Scale, Rotate) }; } catch (e) {};
try { let fnprepatch_812 = AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToHEIF;AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToHEIF = function (SourceImage, Quality = 85, bWantColor = true, bUseGpu = true, Scale = 1, Rotate = "None") { return fnprepatch_812.call(this, SourceImage, Quality, bWantColor, bUseGpu, Scale, Rotate) }; } catch (e) {};
...
try { let fnprepatch_813 = CableComponent.prototype.SetAttachEndToComponent;CableComponent.prototype.SetAttachEndToComponent = function (Component, SocketName = "None") { return fnprepatch_813.call(this, Component, SocketName) }; } catch (e) {};
try { let fnprepatch_814 = CableComponent.prototype.SetAttachEndTo;CableComponent.prototype.SetAttachEndTo = function (Actor, ComponentProperty, SocketName = "None") { return fnprepatch_814.call(this, Actor, ComponentProperty, SocketName) }; } catch (e) {};
...
try { let fnprepatch_815 = EditableMesh.prototype.EndModification;EditableMesh.prototype.EndModification = function (bFromUndo = false) { return fnprepatch_815.call(this, bFromUndo) }; } catch (e) {};
...
try { let fnprepatch_816 = SimpleCartesianPlot.prototype.BP_AddSeriesWithId;SimpleCartesianPlot.prototype.BP_AddSeriesWithId = function (bSuccess, Id, Name, bEnabled = true, bShowPoints = true, bShowLines = false) { return fnprepatch_816.call(this, bSuccess, Id, Name, bEnabled, bShowPoints, bShowLines) }; } catch (e) {};
try { let fnprepatch_817 = SimpleCartesianPlot.prototype.BP_AddSeries;SimpleCartesianPlot.prototype.BP_AddSeries = function (SeriesId, Name, bEnabled = true, bShowPoints = true, bShowLines = false) { return fnprepatch_817.call(this, SeriesId, Name, bEnabled, bShowPoints, bShowLines) }; } catch (e) {};
...
try { let fnprepatch_818 = SimpleTimeSeriesPlot.prototype.BP_AddSeriesWithId;SimpleTimeSeriesPlot.prototype.BP_AddSeriesWithId = function (bSuccess, Id, Name, bEnabled = true, bShowPoints = true, bShowLines = false) { return fnprepatch_818.call(this, bSuccess, Id, Name, bEnabled, bShowPoints, bShowLines) }; } catch (e) {};
try { let fnprepatch_819 = SimpleTimeSeriesPlot.prototype.BP_AddSeries;SimpleTimeSeriesPlot.prototype.BP_AddSeries = function (SeriesId, Name, bEnabled = true, bShowPoints = true, bShowLines = false) { return fnprepatch_819.call(this, SeriesId, Name, bEnabled, bShowPoints, bShowLines) }; } catch (e) {};
